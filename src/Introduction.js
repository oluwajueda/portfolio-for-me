...
<div className='intro'>
   ...
   <div className='para'>
   <p>I am passionate about creating interactive applications and experiences on the web. <br/>
   Collaborative, effective, dynamic, adaptive, able to learn fast on the job, and very concise about meeting deadlines.
   </p>
   </div>
   <div className='intro-btn'>
<a href='#skills' className="btn-underline btn-intro"> Learn more &nbsp; 
